...
function rm.resetSavedOptionsOnClick(resetDefaultsButton)
    resetDefaultsButton:SetScript("OnClick", function(self)
        ...
        local showOppositeFactionAltsTooltipInfo = rm.getPreference("showOppositeFactionAltsTooltipInfo")
        -- Sliders --
        ...
        updateCheckbox(options.showOppositeFactionAltsTooltipInfo, showOppositeFactionAltsTooltipInfo)
        -- Frame scaling --
