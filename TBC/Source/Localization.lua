...
if rm.locale == "enUS" then
    ...
    L.recipePrefixes = {"Recipe: ", "Plans: ", "Formula: ", "Schematic: ", "Pattern: ", "Manual: ", "Design: "}
...
--     end
    L.recipePrefixes = {"Receta: ", "Diseño: ", "Fórmula: ", "Esquema: ", "Patrón: ", "Manual: ", "Boceto: "}
...
elseif rm.locale == "ptBR" then
    ...
    L.recipePrefixes = {"Receita: ", "Instruções: ", "Fórmula: ", "Diagrama: ", "Molde: ", "Manual: ", "Desenho: "}
...
elseif rm.locale == "deDE" then
    ...
    L.recipePrefixes = {"Rezept: ", "Pläne: ", "Formel: ", "Bauplan: ", "Muster: ", "Handbuch: ", "Vorlage: "}
...
elseif rm.locale == "frFR" then
    ...
    L.recipePrefixes = {"Recette : ", "Plan : ", "Plans : ", "Formule : ", "Schéma : ", "Patron : ", "Manuel : ", "Dessin : "}
...
elseif rm.locale == "ruRU" then
    ...
    L.recipePrefixes = {"Рецепт: ", "Чертеж: ", "Формула ", "Формула: ", "Схема: ", "Выкройка: ", "Учебник: ", "Эскиз: "}
...
elseif rm.locale == "koKR" then
    ...
    L.recipePrefixes = {"조리법: ", "도면: ", "주문식: ", "설계도: ", "도안: ", "처방전: ", "디자인: "}
...
elseif rm.locale == "zhTW" then
    ...
    L.recipePrefixes = {"食譜：", "設計圖：", "公式：", "結構圖：", "結構圖 : ", "圖樣：", "圖樣 : ", "說明書：", "手冊：", "配方：", "技藝:"}
...
elseif rm.locale == "zhCN" then
    ...
    L.recipePrefixes = {"食谱：", "配方：", "设计图：", "公式：", "结构图：", "图样：", "手册：", "图鉴："}
    L.backgroundOpacity = "背景不透明度"
    L.blue = "蓝色"
    L.bright = "明亮"
    L.canLearn = "可以学习"
