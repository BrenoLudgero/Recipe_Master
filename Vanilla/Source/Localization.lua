...
if rm.locale == "enUS" then
    ...
    L.showAltsTooltipInfo = "Show other characters' status"
...
elseif rm.locale == "esMX" or rm.locale == "esES" then
    ...
    L.showAltsTooltipInfo = "Mostrar el estado de otros personajes"
...
elseif rm.locale == "ptBR" then
    ...
    L.showAltsTooltipInfo = "Mostrar o estado de outros personagens"
...
elseif rm.locale == "deDE" then
    ...
    L.showAltsTooltipInfo = "Den Status anderer Charaktere anzeigen"
...
elseif rm.locale == "frFR" then
    ...
    L.recipeTooltip = "Rezept-Tooltip"
    L.showAltsTooltipInfo = "Afficher l'état des autres personnages"
...
elseif rm.locale == "ruRU" then
    ...
    L.showAltsTooltipInfo = "Показывать статус других персонажей"
...
elseif rm.locale == "koKR" then
    ...
    L.showAltsTooltipInfo = "다른 캐릭터의 상태 표시"
...
elseif rm.locale == "zhTW" then
    ...
    L.showAltsTooltipInfo = "顯示其他角色的狀態"
...
elseif rm.locale == "zhCN" then
    ...
    L.showAltsTooltipInfo = "显示其他角色的状态"
