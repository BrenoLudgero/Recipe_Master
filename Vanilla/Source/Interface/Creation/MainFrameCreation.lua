...
function rm.createSourcesInstructions(parent)
    ...
    recipe:SetPoint("CENTER", -22, 10)
    recipe:SetSize(85, 85)
    ...
    cursor:SetPoint("TOPLEFT", recipe, "BOTTOMRIGHT", -14, 14)
    ...
    cursor.clickTexture:SetSize(40, 40)
    cursor.clickTexture:SetPoint("BOTTOMRIGHT", cursor, "TOPLEFT", 18, -16)
