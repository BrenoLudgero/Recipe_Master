...
-- Some offsets and sizes change if Skillet is enabled (MainFrameManager.updateSizesAndOffsetsBasedOnParent)
...
F.offsets.mainX = 32
F.offsets.mainTopY = -12
F.offsets.mainBottomY = 63
...
F.sizes.searchBarHeight = 18 -- The clickable height
